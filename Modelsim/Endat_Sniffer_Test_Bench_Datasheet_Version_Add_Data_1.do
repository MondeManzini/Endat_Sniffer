...
add wave -noupdate -divider -height 34 {Additional Data}
...
add wave -noupdate /endat_sniffer_test_bench/add_data_1_done_bit
add wave -noupdate /endat_sniffer_test_bench/add_data_2_enable
add wave -noupdate /endat_sniffer_test_bench/add_data_2_done_bit
...
WaveRestoreCursors {{Cursor 1} {960541330 ps} 0} {{Cursor 2} {63800042 ps} 0}
...
update
WaveRestoreZoom {0 ps} {341276360 ps}
